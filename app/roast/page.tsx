...
// STEP_FRAMES[stepIdx][subFrame] — 14 sub-frames per step, direct swap at 140ms
const STEP_FRAMES: string[][] = [
  // Step 0 — Waking up: eyes scan left↔right, blink, settle
  [
`
   /\\_/\\
  (  o.o )
...
`
  ...
  // Step 1 — Fetching: head tilts down, starts reading
  [
`
   /\\_/\\
  (  -.- )
...
`
  ...
  // Step 2 — Packing: fully looking down, getting concerned
  [
`
   /\\_/\\
  (  v.v )
...
`
  ...
  // Step 3 — Security scan: PURE PANIC, eyes dart frantically
  [
`
   /\\_/\\
  (  O.O )
...
`
  ...
  // Step 4 — Analyzing: deeply resigned, slow breathing
  [
`
   /\\_/\\
  (  -_- )
...
`
  ...
  // Step 5 — Writing verdict: smug, satisfied, glancing around
  [
`
   /\\_/\\
  (  u.u )
